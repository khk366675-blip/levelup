...
export const WORLD_SIGNAL_TEMPLATES = {
  ...
  mystery_v1_clue1: {
    ...
    tier: 'faint' as const,
    title: '📡 이상 징후: 바람의 흔적',
    body: '어둠의 지평선 위로, 오직 외로운 정찰자 하나만이 긴 그림자를 드리우며 홀로 걷는다.',
    spoilerLevel: 1,
  },
  mystery_v1_clue2: {
    id: 'mystery_v1_clue2',
    ...
    tier: 'clear' as const,
    title: '📡 이상 징후: 고독한 좌표',
    body: '그림자가 흩어지지 않고 단 한 줌의 정찰만을 행할 때, 비로소 왜곡된 좌표가 바로잡힐 것이다.',
    spoilerLevel: 1,
  },
  mystery_v1_clue3: {
    id: 'mystery_v1_clue3',
    ...
    tier: 'distorted' as const,
    title: '📡 이상 징후: 외길의 인도',
    body: '단 한 마리의 정찰(Scout)림자를 정찰(Scout) 원정에 홀로 보낼 때, 공간의 공명이 진실을 밝힐 것이다.',
    spoilerLevel: 2,
  },
  mystery_v1_clue4: {
    id: 'mystery_v1_clue4',
    ...
    tier: 'severe' as const,
    title: '📡 이상 징후: 속삭임의 결말',
    body: '다른 동료 없이 오직 1마리의 Scout 그림자만을 Scout 원정에 보내 보상을 획득하라.',
    spoilerLevel: 2,
  },
  mystery_v2_clue1: {
    id: 'mystery_v2_clue1',
    ...
    tier: 'faint' as const,
    title: '📡 이상 징후: 무거운 지식',
    body: '기록의 심연 속에서, 지식을 탐하는 조용한 시선이 자신의 형틀을 깨고 더 깊은 이해로 도약하려 한다.',
    spoilerLevel: 1,
  },
  mystery_v2_clue2: {
    id: 'mystery_v2_clue2',
    ...
    tier: 'clear' as const,
    title: '📡 이상 징후: 기록의 비상',
    body: '정보를 해독하던 그림자가 더 높은 격의 껍질로 나아갈 때, 봉인된 문장이 스스로 해방될 것이다.',
    spoilerLevel: 1,
  },
  mystery_v2_clue3: {
    id: 'mystery_v2_clue3',
    ...
    tier: 'distorted' as const,
    title: '📡 이상 징후: 형상의 전이',
    body: '분석(Analyst) 그림자가 진화의 제단 위에서 형태를 바꿀 때, 흩어진 잔향이 진실로 화하리라.',
    spoilerLevel: 2,
  },
  mystery_v2_clue4: {
    id: 'mystery_v2_clue4',
    ...
    tier: 'severe' as const,
    title: '📡 이상 징후: 해독된 종막',
    body: '부대에 속한 분석(Analyst) 타입의 그림자를 진화(Evolve)시켜서 그 한계를 초월하라.',
    spoilerLevel: 2,
  },
}
