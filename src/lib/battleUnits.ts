...
const SHADOW_CRIT_STAT_SCALE = 0.0015
const SHADOW_FINISHER_CRIT_SCALE = 0.0004
const SHADOW_ACCURACY_BASE = 0.78
const SHADOW_CONTROL_ACCURACY_SCALE = 0.00045
const SHADOW_SUPPRESSION_ACCURACY_SCALE = 0.0003
const SHADOW_SPEED_EVASION_SCALE = 0.0009
const SHADOW_SURVIVAL_EVASION_SCALE = 0.0002
