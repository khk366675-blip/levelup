...
export function getTowerMonsterIds(floor: number): string[] {
  ...
  if (floor <= 15) return [pickRandom(TOWER_FLOOR_MONSTER_POOL.mid)]
  return [pickRandom(TOWER_FLOOR_MONSTER_POOL.late)]
}
...
function createTowerBossDefinition(bossId: string): MonsterDefinition | undefined {
  const bossTemplates: Record<string, Partial<MonsterDefinition> & { stats: MonsterCombatStats }> = {
    'tower-guardian-5': {
      ...
      rank: 'D',
      stats: { maxHp: 360, atk: 75, def: 28, speed: 12, critRate: 0.05, accuracy: 0.91, evasionRate: 0.04 },
    ...
    'tower-knight-10': {
      ...
      rank: 'D',
      stats: { maxHp: 680, atk: 148, def: 48, speed: 16, critRate: 0.07, accuracy: 0.92, evasionRate: 0.06 },
    ...
    'tower-warden-15': {
      ...
      rank: 'C',
      stats: { maxHp: 1050, atk: 210, def: 68, speed: 17, critRate: 0.09, accuracy: 0.93, evasionRate: 0.07 },
    ...
    'tower-judge-20': {
      ...
      rank: 'C',
      stats: { maxHp: 1450, atk: 285, def: 88, speed: 19, critRate: 0.10, accuracy: 0.94, evasionRate: 0.08 },
    ...
    'tower-monarch-25': {
      ...
      rank: 'C',
      stats: { maxHp: 1880, atk: 350, def: 105, speed: 20, critRate: 0.11, accuracy: 0.94, evasionRate: 0.09 },
    ...
    'tower-abyss-30': {
      ...
      rank: 'C',
      stats: { maxHp: 2350, atk: 415, def: 125, speed: 22, critRate: 0.12, accuracy: 0.95, evasionRate: 0.10 },
